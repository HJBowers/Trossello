    ...
    usingSelenium(()=> {
      ...
      describe('when a user is logged in', ()=> {
        it('can click on a previously existing list header and edit the header name', function(done){
          ...
          this.browser.wait(until.elementLocated(By.className('BoardShowPage-List-header')), 2000).click()
        ...
        it('can copy a list using the list popover menu', function(done){
          ...
          this.browser.wait(until.elementLocated(By.css('.ListActionsMenu-CopyListPane textarea')), 2000).sendKeys('Copy List 1')
          this.browser.findElement(By.css('.ListActionsMenu-CopyListPane button'), 2000).click()
